 ...
 */
    ...
    public Definition[] getCaseMembers(Definition def)
    {
        ...
        // debug
        //System.out.println("case members of " + def + " are");
 ...
 */
    ...
    public void swapScopes2()
    {
        for (Enumeration e = classes.elements(); e.hasMoreElements();) {
            CDef c = (CDef)e.nextElement();
            if (c.origSupertype != null) {
                Scope scope = c.origLocals;
                c.origLocals = c.locals;
                c.locals = scope;
            }
        }
    }
