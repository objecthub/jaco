...
// MZ: changed complete class; it uses now specialized stacks
// MZ: added several final modifiers

public final class VirtualParseStack {
  /*-----------------------------------------------------------*/
  /*--- Constructor(s) ----------------------------------------*/
  /*-----------------------------------------------------------*/

  /** Constructor to build a virtual stack out of a real stack. */
  public VirtualParseStack(ParseStack shadowing_stack) throws java.lang.Exception
    {
      /* sanity check */
   ...
   *  unmodified.
   */
  protected ParseStack real_stack;
   ...
   */
  protected final void get_from_real()
    {
      Symbol stack_sym;
...
// MZ: use real_stack's stack pointer
      stack_sym = real_stack.relativeToTop(real_next);
  ...
  public final int top() throws java.lang.Exception
    {
      if (vstack.empty())
    throw new Exception(
  ...
  /** Pop the stack. */
  public final void pop() throws java.lang.Exception
    {
      if (vstack.empty())
    throw new Exception(
  ...
  public final void push(int state_num)
    {
