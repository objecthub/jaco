...
public class lexer {
  ...
  public static void init() throws java.io.IOException
    {
      ...
      next_char = Main.input_file.read();
      if (next_char == EOF_CHAR) {
    next_char2 = EOF_CHAR;
        next_char3 = EOF_CHAR;
        next_char4 = EOF_CHAR;
      } else {
    next_char2 = Main.input_file.read();
    if (next_char2 == EOF_CHAR) {
      next_char3 = EOF_CHAR;
      next_char4 = EOF_CHAR;
    } else {
      next_char3 = Main.input_file.read();
      if (next_char3 == EOF_CHAR) {
        next_char4 = EOF_CHAR;
      } else {
        next_char4 = Main.input_file.read();
      }
    }
      }
    }
  ...
  protected static void swallow_comment() throws java.io.IOException
      ...
      if (next_char2 == '/')
    {
      ...
      /* swallow to '\n', '\f', or EOF */ 
      while (next_char != EOL_CHAR && next_char != '\f' && next_char!=EOF_CHAR)
        advance();
  ...
  protected static Symbol real_next_token() throws java.io.IOException
      ...
      for (;;)
    {
      ...
      if (next_char == ' ' || next_char == '\t' || next_char == '\n' ||
          next_char == '\f' ||  next_char == '\r' || next_char == EOL_CHAR)
        {
